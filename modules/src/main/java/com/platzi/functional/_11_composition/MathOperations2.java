...
public class MathOperations2 {
    public static void main(String[] args) {
        ...
        Function<Integer,Integer> add1MultiplyBy3 =
                multiplyBy3.compose(y->{//con Compose primero se ejecutara la lambda y luego la funcion
                    System.out.println("Le agregare 1 a: "+y);
                    return y + 1;
                });

        Function<Integer,Integer> andSquare =
                add1MultiplyBy3.andThen( x ->{//con andThen ejecutamos la lambda despues de ejecutar el metodo
